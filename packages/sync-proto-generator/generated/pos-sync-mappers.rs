...
fn order_row_from_value(row: &Value) -> OrderRow {
    OrderRow {
        ...
        amount_paid_minor_units: value_to_i64(row, &["amountPaidMinorUnits", "amountPaid"]),
        change_amount_minor_units: value_to_i64(row, &["changeAmountMinorUnits", "changeAmount"]),
        status: value_to_string(row, &["status"]),
        deleted_at: value_to_string(row, &["deletedAt", "deleted_at"]),
        created_at: value_to_string(row, &["createdAt", "created_at"]),
        updated_at: value_to_string(row, &["updatedAt", "updated_at"]),
...
fn orderItem_row_from_value(row: &Value) -> OrderItemRow {
    OrderItemRow {
        ...
        original_price_minor_units: value_to_i64(row, &["originalPriceMinorUnits", "originalPrice"]),
...
pub(super) fn build_merchants_changes(changes: &TablePushChanges) -> MerchantChanges {
    MerchantChanges {
...
pub(super) fn build_outlets_changes(changes: &TablePushChanges) -> OutletChanges {
    OutletChanges {
...
pub(super) fn build_registers_changes(changes: &TablePushChanges) -> RegisterChanges {
    RegisterChanges {
...
pub(super) fn build_categories_changes(changes: &TablePushChanges) -> CategoryChanges {
    CategoryChanges {
...
pub(super) fn build_assets_changes(changes: &TablePushChanges) -> AssetChanges {
    AssetChanges {
...
pub(super) fn build_products_changes(changes: &TablePushChanges) -> ProductChanges {
    ProductChanges {
...
pub(super) fn build_orders_changes(changes: &TablePushChanges) -> OrderChanges {
    OrderChanges {
