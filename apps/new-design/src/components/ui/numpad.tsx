    ...
    <For each={keys}>
      {(k) => (
        <button
          ...
          class={cn(
            "flex min-h-[48px] select-none items-center justify-center rounded-[10px] border-[1.5px] border-border bg-surface font-sans font-semibold text-[20px] text-text transition-[background,border-color,transform] duration-100 hover:border-[rgba(26,51,0,0.12)] hover:bg-surface-gray active:scale-[0.96] active:border-[rgba(26,51,0,0.20)] active:bg-primary-light dark:border-[rgba(255,255,255,0.10)] dark:bg-[#222] dark:text-[#e0e0e0] dark:active:border-accent dark:active:bg-[rgba(26,51,0,0.20)] dark:hover:border-[rgba(255,255,255,0.18)] dark:hover:bg-[#2a2a2a]",
            k.key === "back" &&
