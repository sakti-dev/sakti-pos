...
export default function Payment() {
  ...
  return (
    <SubPageShell backHref="/transaction-new" title="Pembayaran">
        ...
        <div class="flex flex-1 gap-5 overflow-y-auto p-5 max-[900px]:flex-col max-[600px]:gap-3 max-[900px]:gap-4 max-[600px]:p-3 max-[900px]:p-4 max-[600px]:pb-24 max-[900px]:pb-24">
          ...
          <div class="scrollbar-none flex flex-1 flex-col gap-4 overflow-y-auto max-[900px]:order-1 max-[900px]:flex-none max-[900px]:overflow-y-visible">
            ...
            <div class="shrink-0 pt-1 max-[900px]:hidden">
              <Button
                class="h-14 w-full rounded-[14px] font-bold text-[16px] disabled:opacity-40"
                disabled={!canConfirm()}
                onClick={() =>
                  navigate("/receipt", {
                    state: {
      ...
      <div class="fixed inset-x-0 bottom-0 z-[100] hidden border-border border-t bg-surface-gray p-4 pb-4 max-[900px]:block max-[600px]:p-3 max-[600px]:pb-3 dark:border-[rgba(255,255,255,0.06)] dark:bg-[#111]">
        <Button
          class="h-14 w-full rounded-[14px] font-bold text-[16px] disabled:opacity-40"
          disabled={!canConfirm()}
          onClick={() =>
