...
export function UserCard(props: UserCardProps) {
  return (
    <div class="flex flex-col items-center gap-3">
      <div class="relative grid h-[76px] w-[76px] animate-avatar-pulse place-items-center rounded-full border-[3px] border-accent/20 bg-accent-soft font-display font-extrabold text-heading text-primary sm:h-[88px] sm:w-[88px] sm:text-heading">
        {props.user.initials}
