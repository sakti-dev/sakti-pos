  ...
  return (
    ...
    >
      ...
      <div class="relative flex shrink-0 flex-col gap-3 px-[18px] pt-3.5 pb-10 md:px-6 md:pt-4 md:pb-24">
        <FadeIn delay={STAGGER * 0} duration={0.45} y={12}>
          <VenueCard />
        </FadeIn>
        <FadeIn delay={STAGGER * 1} duration={0.45} y={12}>
          <EarningsCard />
        </FadeIn>
      </div>
      ...
      >
        <FadeIn delay={STAGGER * 4} duration={0.4} y={14}>
          <QuickActions />
        </FadeIn>
        <FadeIn delay={STAGGER * 6} duration={0.4} y={14}>
          <KpiCards />
        </FadeIn>
      </FadeIn>
    </div>
