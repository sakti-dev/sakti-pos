...
interface AccountSelectorProps {
  ...
  readonly users: readonly PinUser[];
}
              ...
              <For each={props.users}>
                {(user, i) => (
                  <button
                    ...
                    class="flex animate-stagger-in flex-col items-center gap-2.5 rounded-lg border-2 border-border bg-card px-3 py-6 transition duration-200 hover:border-accent hover:bg-accent-soft hover:shadow-card active:scale-[0.97]"
