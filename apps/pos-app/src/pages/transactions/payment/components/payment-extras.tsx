  ...
  <div class="rounded-lg border border-border/50 bg-card px-6 py-5">
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
      <div>
        ...
        <input
          class="h-11 w-full rounded-sm border-2 border-border bg-background px-3.5 font-sans text-body-sm text-foreground transition-colors transition-shadow duration-150 placeholder:text-faint-foreground focus:border-primary focus:bg-card focus:outline-none focus:ring-2 focus:ring-primary/10"
          id="customer"
