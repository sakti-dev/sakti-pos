			...
			<AppShell
				...
				topbarSuffix={
					<div class="hidden items-center landscape:flex">
						<Show
							when={(props.state.role === "manager" || props.state.role === "owner") && props.state.outlets().length > 0}
						>
							<OutletSelector
						...
						<TextField class="gap-0" onChange={props.state.setSearch} value={props.state.search()}>
