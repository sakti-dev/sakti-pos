	...
	return (
		<Show when={props.outlets.length > 1}>
			<div class="relative">
				<button
					type="button"
					class="flex items-center gap-1.5 rounded-lg px-2 py-1 text-sm font-medium hover:bg-accent"
				...
				<Show when={open()}>
					<div class="absolute left-0 top-full z-50 mt-1 min-w-[200px] rounded-xl border bg-card p-1 shadow-lg">
