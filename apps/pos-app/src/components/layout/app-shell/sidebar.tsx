...
export const Sidebar = (props: SidebarProps) => {
  return (
    ...
    >
      <nav
        class={cn(
          "relative flex h-full w-sidebar-expanded flex-col border-border border-t border-r bg-card px-3 pt-5 pb-4 transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] lg:flex",
          props.expanded
